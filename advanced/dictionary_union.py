...
def main():
    test_combining_list_set()
    test_dict_or_disjoint_keys()
    test_dict_or_non_disjoint_keys()
    test_dict_or_not_commutative()
    test_not_even_plain_or_is_commutative()
    test_dict_ior_syntax()

    test_time_dict_aggregation()
